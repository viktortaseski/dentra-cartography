...
const listPatients = () => window.electron.listPatients();
const createPatient = (data) => window.electron.createPatient(data);
const updatePatient = (id2, data) => window.electron.updatePatient(id2, data);
const archivePatient = (id2) => window.electron.archivePatient(id2);
const getChartForPatient = (patientId) => window.electron.getChartForPatient(patientId);
const setToothCondition = (data) => window.electron.setToothCondition(data);
const listTreatmentsForTooth = (patientId, toothFdi) => window.electron.listTreatmentsForTooth(patientId, toothFdi);
const listTreatmentsForPatient = (patientId) => window.electron.listTreatmentsForPatient(patientId);
const addTreatment = (data) => window.electron.addTreatment(data);
const usePatientStore = create((set, get) => ({
  ...
  updatePatient: async (id2, data) => {
    set({ isLoading: true, error: null });
    try {
      const updated = await updatePatient(id2, data);
      set((state) => ({
        patients: state.patients.map((p2) => p2.id === id2 ? updated : p2),
        isLoading: false
      }));
    } catch (err) {
      set({
  ...
  archivePatient: async (id2) => {
    set({ isLoading: true, error: null });
    try {
      await archivePatient(id2);
      set((state) => {
        const nextSelectedId = state.selectedPatientId === id2 ? null : state.selectedPatientId;
        return {
          patients: state.patients.filter((p2) => p2.id !== id2),
  ...
  selectPatient: (id2) => {
    set({ selectedPatientId: id2 });
  }
}));
const selectSelectedPatient = (state) => {
  if (state.selectedPatientId === null) return null;
  return state.patients.find((p2) => p2.id === state.selectedPatientId) ?? null;
};
const useTreatmentStore = create((set) => ({
  ...
  error: null,
  // Actions
  loadTreatmentsForPatient: async (patientId) => {
    set({ isLoading: true, error: null });
    try {
  ...
  loadTreatmentsForTooth: async (patientId, toothFdi) => {
    set({ isLoading: true, error: null });
    try {
...
const useChartStore = create((set, get) => ({
    ...
    try {
      ...
      try {
        await addTreatment({
          ...
          status: "completed",
          datePerformed: (/* @__PURE__ */ new Date()).toISOString().split("T")[0],
          performedBy: null,
          notes: null
        });
      ...
      set((state) => {
        ...
        const updatedEntries = state.chartEntries.map((entry) => {
          ...
          const updatedSurfaces = surfaceExists ? entry.surfaces.map(
            (s) => s.surface === req.surface ? { surface: req.surface, condition: req.condition } : s
  ...
  openConditionPicker: (toothFdi, surface) => {
...
function formatDob$1(dateOfBirth) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ...
      className: [
        ...
        isSelected ? "bg-blue-50 border border-blue-200" : "bg-white border border-transparent hover:bg-gray-50 hover:border-gray-200"
      ].join(" "),
      "aria-selected": isSelected,
      "aria-label": `Select patient ${patient.fullName}`,
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `text-sm font-semibold truncate ${isSelected ? "text-blue-700" : "text-gray-900"}`, children: patient.fullName }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-500 mt-0.5", children: [
            "DOB: ",
            formatDob$1(patient.dateOfBirth)
          ] })
        ] }),
        patient.medicalAlerts && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
...
function Sidebar({
  ...
  const filtered = query.trim() ? patients.filter(
    (p2) => p2.fullName.toLowerCase().includes(query.trim().toLowerCase())
  ) : patients;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "aside",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pt-4 pb-3 border-b border-gray-100", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-sm font-semibold text-gray-900 mb-3", children: "Patients" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto px-2 py-2 space-y-1", role: "list", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 text-center mt-8", children: "Loading…" }) : filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 text-center mt-8", children: query.trim() ? "No patients match your search." : "No patients yet." }) : filtered.map((patient) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { role: "listitem", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          PatientCard,
          {
            patient,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-4 border-t border-gray-100", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-4 h-4", viewBox: "0 0 20 20", fill: "currentColor", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" }) }),
              "New Patient"
            ]
          }
        ) })
...
function TopBar({ patient, onEditPatient, onArchivePatient }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex items-center justify-between h-14 px-6 bg-white border-b border-gray-200 flex-shrink-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-blue-700 tracking-tight select-none", children: "Dental Cartography" }),
      patient && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "svg",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-gray-900 truncate", children: patient.fullName }),
    ...
    patient && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-4 h-4", viewBox: "0 0 20 20", fill: "currentColor", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" }) }),
            "Edit"
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: "w-4 h-4", viewBox: "0 0 20 20", fill: "currentColor", "aria-hidden": "true", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M4 3a2 2 0 100 4h12a2 2 0 100-4H4z" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "path",
                {
                  fillRule: "evenodd",
...
function patientToFields(p2) {
  return {
    ...
    phone: p2.phone ?? "",
    email: p2.email ?? "",
    medicalAlerts: p2.medicalAlerts ?? "",
    notes: p2.notes ?? ""
  };
}
function PatientForm({ patient, onClose }) {
  const { createPatient: createPatient2, updatePatient: updatePatient2, isLoading, error } = usePatientStore();
  ...
  async function handleSubmit(e) {
    ...
    if (patient) {
      ...
      await updatePatient2(patient.id, data);
    } else {
      const data = {
        fullName: fields.fullName.trim(),
        dateOfBirth: fields.dateOfBirth,
  ...
  return (
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-xl shadow-xl w-full max-w-lg mx-4 overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-4 border-b border-gray-100 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { id: "patient-form-title", className: "text-base font-semibold text-gray-900", children: patient ? "Edit Patient" : "New Patient" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-5 h-5", viewBox: "0 0 20 20", fill: "currentColor", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" }) })
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, noValidate: true, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-5 space-y-4 max-h-[70vh] overflow-y-auto", children: [
              displayedError && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-red-600 bg-red-50 border border-red-200 rounded-lg px-3 py-2", role: "alert", children: displayedError }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { htmlFor: "pf-fullName", className: "block text-sm font-medium text-gray-700 mb-1", children: [
                  "Full Name ",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { htmlFor: "pf-dob", className: "block text-sm font-medium text-gray-700 mb-1", children: [
                    "Date of Birth ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-red-500", children: "*" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "pf-sex", className: "block text-sm font-medium text-gray-700 mb-1", children: "Sex" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "select",
                    {
                      id: "pf-sex",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "pf-phone", className: "block text-sm font-medium text-gray-700 mb-1", children: "Phone" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      id: "pf-phone",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "pf-email", className: "block text-sm font-medium text-gray-700 mb-1", children: "Email" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      id: "pf-email",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "pf-medicalAlerts", className: "block text-sm font-medium text-gray-700 mb-1", children: "Medical Alerts" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "textarea",
                  {
                    id: "pf-medicalAlerts",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "pf-notes", className: "block text-sm font-medium text-gray-700 mb-1", children: "Notes" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "textarea",
                  {
                    id: "pf-notes",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-4 border-t border-gray-100 flex justify-end gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: isLoading ? "Saving…" : patient ? "Save Changes" : "Create Patient"
                }
              )
            ] })
          ] })
...
function TreatmentRow({ treatment }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 px-4 py-3 border-b border-gray-100 last:border-b-0 hover:bg-gray-50 transition-colors", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500 w-24 shrink-0 pt-0.5 font-mono", children: formatDate(treatment.datePerformed) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-gray-700 w-10 shrink-0 pt-0.5", children: treatment.toothFdi }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500 w-16 shrink-0 pt-0.5 capitalize", children: treatment.surface ?? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-300", children: "—" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5 min-w-0 shrink-0 pt-0.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-700", children: config.label })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
        className: `inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium shrink-0 ${statusClass}`,
        children: treatment.status.charAt(0).toUpperCase() + treatment.status.slice(1)
      }
    ),
    treatment.performedBy && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400 shrink-0 pt-0.5 hidden sm:inline", children: treatment.performedBy }),
    treatment.notes && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
        className: "text-xs text-gray-400 min-w-0 truncate pt-0.5",
        title: treatment.notes,
        children: truncate(treatment.notes, 60)
      }
    )
  ] });
}
const SURFACES = ["occlusal", "mesial", "distal", "buccal", "lingual", "incisal"];
const ALL_CONDITIONS$1 = [
  "healthy",
  "caries",
  "filling_amalgam",
  "filling_composite",
...
function TreatmentForm({
  ...
  const { addTreatment: addTreatment2, isLoading, error } = useTreatmentStore();
  const [fields, setFields] = reactExports.useState({
    toothFdi: initialToothFdi !== void 0 ? String(initialToothFdi) : "",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-xl shadow-xl w-full max-w-lg mx-4 overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-4 border-b border-gray-100 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { id: "treatment-form-title", className: "text-base font-semibold text-gray-900", children: "Add Treatment" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, noValidate: true, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-5 space-y-4 max-h-[70vh] overflow-y-auto", children: [
            displayedError && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "select",
                  {
                    ...
                    className: "w-full rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "Whole tooth" }),
                      SURFACES.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: s, children: s.charAt(0).toUpperCase() + s.slice(1) }, s))
                    ]
                  }
                )
              ] })
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "select",
                {
                  ...
                  children: [
                    ...
                    ALL_CONDITIONS$1.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: c, children: CONDITION_CONFIG[c].label }, c))
                  ]
                }
              )
            ] }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "select",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "referred", children: "Referred" })
                    ]
                  }
                )
              ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-4 border-t border-gray-100 flex justify-end gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                disabled: isLoading,
                className: "px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500",
                children: isLoading ? "Saving…" : "Add Treatment"
              }
            )
          ] })
        ] })
...
function TreatmentPanel({ patientId, selectedToothFdi }) {
  ...
  const displayedTreatments = reactExports.useMemo(() => {
    if (selectedToothFdi === null) return treatments;
    return treatments.filter((t2) => t2.toothFdi === selectedToothFdi);
  }, [treatments, selectedToothFdi]);
  const formInitialSurface = selectedSurface !== null ? selectedSurface : void 0;
  const formInitialCondition = selectedToothFdi !== null && selectedSurface !== null ? getCondition(selectedToothFdi, selectedSurface) : void 0;
  function handleSaved() {
    setFormOpen(false);
    void loadTreatmentsForPatient(patientId);
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-gray-200 bg-white flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-3 border-b border-gray-100", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-gray-900", children: "Treatment History" }),
        selectedToothFdi !== null ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800", children: [
          "Tooth ",
          selectedToothFdi
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-600", children: "All Teeth" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-3.5 h-3.5", viewBox: "0 0 20 20", fill: "currentColor", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M10.75 4.75a.75.75 0 00-1.5 0v4.5h-4.5a.75.75 0 000 1.5h4.5v4.5a.75.75 0 001.5 0v-4.5h4.5a.75.75 0 000-1.5h-4.5v-4.5z" }) }),
            "Add Treatment"
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-4 py-2 bg-gray-50 border-b border-gray-100", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-gray-400 uppercase tracking-wide w-24 shrink-0", children: "Date" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-gray-400 uppercase tracking-wide w-10 shrink-0", children: "Tooth" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-gray-400 uppercase tracking-wide w-16 shrink-0", children: "Surface" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-gray-400 uppercase tracking-wide shrink-0", children: "Condition" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-gray-400 uppercase tracking-wide shrink-0 ml-1", children: "Status" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-y-auto max-h-64", children: [
      isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500 px-4 py-6 text-center", "aria-live": "polite", children: "Loading treatments…" }),
      !isLoading && error && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
      ...
      !isLoading && !error && displayedTreatments.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-10 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "svg",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500", children: "No treatments recorded" }),
        selectedToothFdi !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-400 mt-1", children: [
          "for tooth ",
          selectedToothFdi
        ] })
      ] }),
      !isLoading && !error && displayedTreatments.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { role: "list", "aria-label": "Treatment history", children: displayedTreatments.map((treatment) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { role: "listitem", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TreatmentRow, { treatment }) }, treatment.id)) })
    ] }),
    formOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
      TreatmentForm,
      {
        patientId,
        initialToothFdi: selectedToothFdi ?? void 0,
...
const ANTERIOR_SURFACES = ["mesial", "distal", "buccal", "lingual", "incisal"];
const POSTERIOR_SURFACES = ["mesial", "distal", "buccal", "lingual", "occlusal"];
...
const PERMANENT_TEETH_BY_FDI = new Map(
  PERMANENT_TEETH.map((t2) => [t2.fdi, t2])
);
function getToothDefinition(fdi) {
  return PERMANENT_TEETH_BY_FDI.get(fdi);
}
const STROKE_NORMAL = "#9ca3af";
const STROKE_SELECTED = "#1d4ed8";
const STROKE_WIDTH = 0.5;
const HEALTHY_FILL = "#e5e7eb";
const CENTER_RECT = { x: 12, y: 12, width: 16, height: 16 };
const SURFACE_POLYGONS = {
  buccal: "12,12 28,12 20,4",
  lingual: "12,28 28,28 20,36",
  mesial: "12,12 12,28 4,20",
  distal: "28,12 28,28 36,20"
};
function getSurfaceFill(surface, chartEntry) {
...
function ToothSVG({ fdi, chartEntry, isSelected }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      overflow: "visible",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: definition ? definition.name : `Tooth ${fdi}` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "rect",
          {
            x: CENTER_RECT.x,
...
function ConditionPicker() {
  ...
  async function handleSelectCondition(condition) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-xl shadow-xl w-full max-w-sm mx-4 overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-4 border-b border-gray-100 flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-4 h-4", viewBox: "0 0 20 20", fill: "currentColor", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" }) })
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2", children: ALL_CONDITIONS.map((condition) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-700 leading-tight", children: config.label })
              ]
            },
            condition
          );
        }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 py-3 border-t border-gray-100 flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: closeConditionPicker,
...
function getEntryForTooth(chartEntries, fdi) {
...
function ArchRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center gap-0.5", role: "row", children: fdis.map((fdi, index) => {
    const isMidGap = index === 7;
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex items-center${isMidGap ? " mr-3" : ""}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      ToothSVG,
      {
        fdi,
...
function QuadrantLabels({ fdis }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center gap-0.5", "aria-hidden": "true", children: fdis.map((fdi, index) => {
    const isMidGap = index === 7;
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: `w-10 text-center text-xs text-gray-400 font-mono${isMidGap ? " mr-3" : ""}`,
        children: fdi
      },
      fdi
    );
...
const DEFINED_FDI_SET = new Set(PERMANENT_TEETH.map((t2) => t2.fdi));
function assertAllDefined(fdis, archName) {
...
function DentalChart({ patientId }) {
  const { chartEntries, isLoading, error, conditionPickerOpen, selectedToothFdi, loadChart } = useChartStore();
  reactExports.useEffect(() => {
    void loadChart(patientId);
  }, [patientId, loadChart]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center py-6 px-4 gap-4 select-none", children: [
    ...
    isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500", "aria-live": "polite", children: "Loading chart..." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        role: "table",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-xs font-medium text-gray-400 uppercase tracking-widest mb-1", children: "Upper" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(QuadrantLabels, { fdis: UPPER_ARCH_FDI }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ArchRow,
            {
              fdis: UPPER_ARCH_FDI,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "my-3 border-t border-dashed border-gray-200 w-full", "aria-hidden": "true" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ArchRow,
            {
              fdis: LOWER_ARCH_FDI,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(QuadrantLabels, { fdis: LOWER_ARCH_FDI }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-xs font-medium text-gray-400 uppercase tracking-widest mt-1", children: "Lower" })
        ]
      }
    ),
    conditionPickerOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(ConditionPicker, {})
  ] });
}
function ChartView({ patientId }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full overflow-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DentalChart, { patientId }) });
}
function Dashboard() {
  const { patients, selectedPatientId, isLoading, loadPatients, selectPatient, archivePatient: archivePatient2 } = usePatientStore();
  const selectedPatient = usePatientStore(selectSelectedPatient);
  const selectedToothFdi = useChartStore((s) => s.selectedToothFdi);
  const [modal, setModal] = reactExports.useState({ kind: "closed" });
  reactExports.useEffect(() => {
    void loadPatients();
  }, [loadPatients]);
  ...
  async function handleArchivePatient() {
    if (selectedPatient) {
      ...
      if (confirmed) {
        await archivePatient2(selectedPatient.id);
      }
    }
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen bg-gray-50 text-gray-900 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Sidebar,
      {
        patients,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col flex-1 min-w-0 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 overflow-y-auto flex flex-col", children: selectedPatient ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ChartView, { patientId: selectedPatient.id }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          TreatmentPanel,
          {
      ...
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-1 items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "svg",
          {
            ...
            "aria-hidden": "true",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "8", y: "8", width: "32", height: "32", rx: "6", stroke: "currentColor", strokeWidth: "2" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "24", cy: "20", r: "5", stroke: "currentColor", strokeWidth: "2" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "path",
                {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-medium text-gray-500", children: "Select a patient to view their chart" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-400 mt-1", children: "Choose a patient from the sidebar or create a new one." })
      ] }) }) })
    ] }),
    modal.kind === "create" && /* @__PURE__ */ jsxRuntimeExports.jsx(PatientForm, { onClose: handleCloseModal }),
    modal.kind === "edit" && /* @__PURE__ */ jsxRuntimeExports.jsx(PatientForm, { patient: modal.patient, onClose: handleCloseModal })
  ] });
}
function App() {
